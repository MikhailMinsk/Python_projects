...
class QuestionModelTests(TestCase):
    def test_was_published_with_future_question(self):
        ...
        whose data_public is in the future
        """
        time = timezone.now() + datetime.timedelta(days=30)
        future_question = Questions(date_public=time)
    ...
    def test_was_published_with_old_question(self):
        ...
        old_question = Questions(date_public=time)
    ...
    def test_was_published_with_recent_question(self):
        ...
        recent_question = Questions(date_public=time)
        self.assertIs(recent_question.was_published(), False)
...
def create_question(question_text, days):
    ...
    return Questions.objects.create(question_text=question_text, date_public=time)
...
class QuestionIndexViewTest(TestCase):
    def test_no_questions(self):
        ...
        self.assertNotContains(response, 'No available')
